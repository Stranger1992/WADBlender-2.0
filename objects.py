...
# Placeholders and non-mesh objects to skip during batch import
movables2discard = {
    # AI markers (no mesh, just triggers)
    'AI_GUARD', 'AI_AMBUSH', 'AI_PATROL1', 'AI_MODIFY', 'AI_FOLLOW', 'AI_PATROL2', 'AI_X1', 'AI_X2',
    # Triggers and markers
    'LARA_START_POS', 'KILL_ALL_TRIGGERS', 'TRIGGER_TRIGGERER', 'CAMERA_TARGET',
    # Particle emitters
    ...
    'BUBBLES', 'WATERFALLMIST', 'EARTHQUAKE',
    # Special objects
    'ROPE', 'FIREROPE',
    'VEHICLE_EXTRA_MVB',
}
