...
- Mixamo animation import and retargeting to the `LARA_RIG` armature (the importer expects this exact object name)
...
- Importing multiple WADs into one .blend can create name conflicts (duplicate object/collection names or texture page reuse); import into separate files, or prefix/rename imported collections and texture pages before bringing in a second WAD.
